...
Для выхода из программы введите `exit` или `Ctrl-D`.
...
*   **`repository/` — Реализации интерфейсов.**
    *   Содержит конкретные реализации команд, репозиториев для работы с историей команд и стеком отмены действий.
